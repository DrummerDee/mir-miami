    ...
    return (
        <div className='body'>
            ...
            <div className='wrapper'>
                <div className='frame'>
                    <div className='box'>
                        <img className='before' src={sinkbefore} alt='broken sink' />
                        <img className='after' src={sinkafter} alt='broken sink' />
                    </div>
                </div>
            </div>
            <div className='wrapper'>
            ...
            <div className='wrapper'>
                ...
                {/* <div className='wrapper'>
                    <div className='frame'>
                        <div className='box'>
                            <img className='before' src={roofbefore2} alt='roof before' />
                            <img className='after' src={roofafter2} alt='roof after' />
                        </div>
                    </div>
                </div> */}
                </div>
